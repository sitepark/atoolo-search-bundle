...
class Schema2xFieldMapper
{
    public function getFacetField(Facet $facet): string
    {
        return match (true) {
            ...
            $facet instanceof RelativeDateRangeFacet,
            $facet instanceof AbsoluteDateRangeFacet => 'sp_date',
    ...
    public function getFilterField(Filter $filter): string
    {
        return match (true) {
            ...
            $filter instanceof ContentSectionTypeFilter,
            $filter instanceof TeaserPropertyFilter => 'sp_contenttype',
            ...
            $filter instanceof AbsoluteDateRangeFilter => 'sp_date',
            $filter instanceof SpatialOrbitalFilter,
            $filter instanceof SpatialArbitraryRectangleFilter => $this->getGeoPointField(),
